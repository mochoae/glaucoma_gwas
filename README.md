...
This study explores the influence of genetic ancestry on the genetic risk profile related to glaucoma in Colombian populations. We assessed allele frequency differences between African- and European-ancestry groups and performed correlation analyses.
...
4. Install required R packages (see script).
